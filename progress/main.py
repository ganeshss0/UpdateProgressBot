from progress.utils import CURRENT_DATE, extract_data, save_dataset, ONE_DAY_TIMEDELTA
from progress.progress_data.visualization import plot_visualization
from progress.progress_data.CreateTemplate import add_month_row
from progress.utils import pd, logging
...
def main(data:pd.DataFrame, dataset_file_path, visualization_path) -> None:
    ...
    if next_day.day < CURRENT_DATE.day and data.iloc[-1, 0].month != next_day.month:
